document.addEventListener('DOMContentLoaded', () => {
    ...
    async function sendDataToSheets(data) {
        ...
        // URL do Web App do Google Apps Script (Você deve substituir após publicar o script no Google)
        const GOOGLE_SCRIPT_URL = 'SUA_URL_DO_GOOGLE_SCRIPT_AQUI';

        try {
            if (GOOGLE_SCRIPT_URL === 'SUA_URL_DO_GOOGLE_SCRIPT_AQUI') {
                console.warn("Configuração pendente: URL do Google Script não definida.");
                statusEl.textContent = "Resultados salvos localmente (Configuração do RH pendente).";
                return;
            }
